...
def join_send_htmlemail_1(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None, custom_function=None, loop_state_json=None, **kwargs):
    ...
    if phantom.completed(playbook_names=["playbook_saa_dynamic_email_analysis_1"], custom_function_names=["regex_extract_email_11"]):
...
def regex_extract_email_11(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None, custom_function=None, loop_state_json=None, **kwargs):
    ...
    phantom.custom_function(custom_function="community/regex_extract_email", parameters=parameters, name="regex_extract_email_11", callback=regex_extract_email_11_callback)

    return


@phantom.playbook_block()
def regex_extract_email_11_callback(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None, custom_function=None, loop_state_json=None, **kwargs):
    phantom.debug("regex_extract_email_11_callback() called")
