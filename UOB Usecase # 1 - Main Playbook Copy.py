...
def debug_4(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None, custom_function=None, loop_state_json=None, **kwargs):
    ...
    phantom.custom_function(custom_function="community/debug", parameters=parameters, name="debug_4", callback=playbook_uob_use_case__1___saa_dynamic_email_analysis_subplaybook_1)
...
def add_note_observable_details(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None, custom_function=None, loop_state_json=None, **kwargs):
    ...
    playbook_uob_use_case__1___saa_dynamic_email_analysis_subplaybook_1_output_observable = phantom.collect2(container=container, datapath=["playbook_uob_use_case__1___saa_dynamic_email_analysis_subplaybook_1:playbook_output:observable"])

    playbook_uob_use_case__1___saa_dynamic_email_analysis_subplaybook_1_output_observable_values = [item[0] for item in playbook_uob_use_case__1___saa_dynamic_email_analysis_subplaybook_1_output_observable]
    ...
    for item in playbook_uob_use_case__1___saa_dynamic_email_analysis_subplaybook_1_output_observable_values:
        if item is not None:
    ...
    phantom.add_note(container=container, content=playbook_uob_use_case__1___saa_dynamic_email_analysis_subplaybook_1_output_observable_values, note_format="markdown", note_type="general", title="Obervable details")
...
def add_note_saa_report(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None, custom_function=None, loop_state_json=None, **kwargs):
    ...
    playbook_uob_use_case__1___saa_dynamic_email_analysis_subplaybook_1_output_report = phantom.collect2(container=container, datapath=["playbook_uob_use_case__1___saa_dynamic_email_analysis_subplaybook_1:playbook_output:report"])

    playbook_uob_use_case__1___saa_dynamic_email_analysis_subplaybook_1_output_report_values = [item[0] for item in playbook_uob_use_case__1___saa_dynamic_email_analysis_subplaybook_1_output_report]
    ...
    report_data = str()
    for item in playbook_uob_use_case__1___saa_dynamic_email_analysis_subplaybook_1_output_report_values:
        if item is not None:
            report_data = item
    ...
    phantom.add_note(container=container, content=playbook_uob_use_case__1___saa_dynamic_email_analysis_subplaybook_1_output_report_values, note_format="markdown", note_type="general", title="Email Analysis Report")
...
def add_note_whois_info(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None, custom_function=None, loop_state_json=None, **kwargs):
    ...
    playbook_uob_use_case__1___saa_dynamic_email_analysis_subplaybook_1_output_whois_note = phantom.collect2(container=container, datapath=["playbook_uob_use_case__1___saa_dynamic_email_analysis_subplaybook_1:playbook_output:whois_note"])

    playbook_uob_use_case__1___saa_dynamic_email_analysis_subplaybook_1_output_whois_note_values = [item[0] for item in playbook_uob_use_case__1___saa_dynamic_email_analysis_subplaybook_1_output_whois_note]
    ...
    # Write your custom code here...
    playbook_saa_dynamic_email_analysis_1_output_whois_note_values = playbook_uob_use_case__1___saa_dynamic_email_analysis_subplaybook_1_output_whois_note_values[0]

    ################################################################################
    ## Custom Code End
    ################################################################################

    phantom.add_note(container=container, content=playbook_uob_use_case__1___saa_dynamic_email_analysis_subplaybook_1_output_whois_note_values, note_format="markdown", note_type="general", title="Suspected domain's whois information:")
...
def debug_2(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None, custom_function=None, loop_state_json=None, **kwargs):
    ...
    playbook_uob_use_case__1___saa_dynamic_email_analysis_subplaybook_1_output_verdict = phantom.collect2(container=container, datapath=["playbook_uob_use_case__1___saa_dynamic_email_analysis_subplaybook_1:playbook_output:verdict"])

    playbook_uob_use_case__1___saa_dynamic_email_analysis_subplaybook_1_output_verdict_values = [item[0] for item in playbook_uob_use_case__1___saa_dynamic_email_analysis_subplaybook_1_output_verdict]

    parameters = []

    parameters.append({
        "input_1": playbook_uob_use_case__1___saa_dynamic_email_analysis_subplaybook_1_output_verdict_values,
        "input_2": None,
        "input_3": None,
        "input_4": None,
        "input_5": None,
...
@phantom.playbook_block()
def playbook_uob_use_case___1___adding_notes_to_the_incident_subplaybook_1(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None, custom_function=None, loop_state_json=None, **kwargs):
    phantom.debug("playbook_uob_use_case___1___adding_notes_to_the_incident_subplaybook_1() called")
...
@phantom.playbook_block()
def playbook_uob_use_case__1___saa_dynamic_email_analysis_subplaybook_1(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None, custom_function=None, loop_state_json=None, **kwargs):
    phantom.debug("playbook_uob_use_case__1___saa_dynamic_email_analysis_subplaybook_1() called")

    extract_email_1_result_data = phantom.collect2(container=container, datapath=["extract_email_1:action_result.parameter.vault_id"], action_results=results)

    extract_email_1_parameter_vault_id = [item[0] for item in extract_email_1_result_data]

    inputs = {
        "vault_id": extract_email_1_parameter_vault_id,
    }
    ...
    # call playbook "local/UOB Use case #1 - SAA_Dynamic_Email_Analysis Subplaybook", returns the playbook_run_id
    playbook_run_id = phantom.playbook("local/UOB Use case #1 - SAA_Dynamic_Email_Analysis Subplaybook", container=container, name="playbook_uob_use_case__1___saa_dynamic_email_analysis_subplaybook_1", callback=add_note_whois_info, inputs=inputs)
