...
def debug_8(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None, custom_function=None, loop_state_json=None, **kwargs):
    ...
    find_related_containers_4__result = phantom.collect2(container=container, datapath=["find_related_containers_4:custom_function_result.message"])

    find_related_containers_4_message = [item[0] for item in find_related_containers_4__result]

    parameters = []

    parameters.append({
        "input_1": find_related_containers_4_message,
        "input_2": None,
        "input_3": None,
        "input_4": None,
        "input_5": None,
