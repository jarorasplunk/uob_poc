...
def extract_ioc_1(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None, custom_function=None, loop_state_json=None, **kwargs):
    ...
    phantom.act("extract ioc", parameters=parameters, name="extract_ioc_1", assets=["soar_poc_parser"], callback=join_playbook_soar_poc_put_ioc_custom_list_2)
...
def extract_ioc_2(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None, custom_function=None, loop_state_json=None, **kwargs):
    ...
    phantom.act("extract ioc", parameters=parameters, name="extract_ioc_2", assets=["soar_poc_parser"], callback=join_playbook_soar_poc_put_ioc_custom_list_2)
...
def extract_ioc_3(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None, custom_function=None, loop_state_json=None, **kwargs):
    ...
    phantom.act("extract ioc", parameters=parameters, name="extract_ioc_3", assets=["soar_poc_parser"], callback=join_playbook_soar_poc_put_ioc_custom_list_2)

    return


@phantom.playbook_block()
def join_playbook_soar_poc_put_ioc_custom_list_2(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None, custom_function=None, loop_state_json=None, **kwargs):
    phantom.debug("join_playbook_soar_poc_put_ioc_custom_list_2() called")

    if phantom.completed(action_names=["extract_ioc_1", "extract_ioc_2", "extract_ioc_3"]):
        # call connected block "playbook_soar_poc_put_ioc_custom_list_2"
        playbook_soar_poc_put_ioc_custom_list_2(container=container, handle=handle)
...
def playbook_soar_poc_put_ioc_custom_list_2_callback(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None, custom_function=None, loop_state_json=None, **kwargs):
    ...
    playbook_soar_poc_execute_search_ip_1(action=action, success=success, container=container, results=results, handle=handle, filtered_artifacts=filtered_artifacts, filtered_results=filtered_results)
    playbook_soar_poc_execute_search_domain_1(action=action, success=success, container=container, results=results, handle=handle, filtered_artifacts=filtered_artifacts, filtered_results=filtered_results)
    playbook_soar_poc_execute_search_md5_1(action=action, success=success, container=container, results=results, handle=handle, filtered_artifacts=filtered_artifacts, filtered_results=filtered_results)
